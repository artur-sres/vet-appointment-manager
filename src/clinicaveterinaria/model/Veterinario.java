...
public class Veterinario extends Pessoa {
    private final ArrayList<Atendimento> agendaConsultas = new ArrayList<>();
    ...
    // Verifica se um determinado agendamento pode ser feito naquele intervalo de tempo dentro dos horarios idisponiveis do Veterinário
    ...
    public boolean isHorarioDisponivel(LocalDate dataAtendimento, LocalTime horaInicio, int duracaoMinutos, Atendimento ignorar) {
        ...
        //Define os intervalos de tempo úteis do veterinário
