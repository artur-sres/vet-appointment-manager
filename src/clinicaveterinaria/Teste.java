...
public class Teste {
    ...
    public static void testePets() {
        try {
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(3),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(5),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(8),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(11),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(4),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(6),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(7),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(9),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(10),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(12),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(13),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(14),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(15),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(16),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(17),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(18),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(19),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(20),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(21),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(22),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(23),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(24),
            ...
            PetController.cadastrarPet(
                TutorController.listaTutores.get(0), // Gabriel ganha mais um
                Especie.GATO, "Mochi", "Siamês", Sexo.MACHO, "3.9",
                LocalDate.of(2024, 1, 10), "Nenhuma", "Filhote novo", false, false
            );

            PetController.cadastrarPet(
                TutorController.listaTutores.get(24), // Aline ganha mais um
        ...
        try {
            ...
            for (LocalDate data = dataInicio; !data.isAfter(dataFim); data = data.plusDays(1)) {
                ...
                for (int i = 0; i < qtdAtendimentosHoje; i++) {
                    ...
                    var pet = PetController.listaPets.get(random.nextInt(PetController.listaPets.size()));
                    var vet = VeterinarioController.listaVeterinarios.get(random.nextInt(VeterinarioController.listaVeterinarios.size()));
